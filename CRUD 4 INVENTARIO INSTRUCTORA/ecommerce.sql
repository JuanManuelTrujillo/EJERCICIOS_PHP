...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-11-2023 a las 18:22:40
...
CREATE TABLE `marcas` (
  `Id` int NOT NULL,
  `NombreMarca` varchar(100) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `productos` (
  ...
  `Precio` varchar(200) COLLATE utf8mb4_general_ci NOT NULL,
  `DescripcionProducto` varchar(500) COLLATE utf8mb4_general_ci NOT NULL,
