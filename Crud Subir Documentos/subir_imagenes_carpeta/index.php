...
<body>
  <div class="container">
    ...
    <span aria-hidden="true">&times;</span>
       ...
       <div class="col-lg-8">
         ...
         <div class="card">
      <img src="Backend/carpeta_imagenes/<?php echo $row['imagen']; ?>" class="card-img-top" alt="...">
       <div class="card-body">
  ...
  <div class="container">
  <a href="Eliminar.php?imagen=<?php echo $row['cod_imagen'] ;?>" class="btn btn-success" onclick="return confirmacion()">Eliminar</a>
        </div>
  <?php }?>
       </div>
    </div>
